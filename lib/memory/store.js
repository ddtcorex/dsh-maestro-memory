...
import { readEntriesSync, appendEntryAtomicSync, writeEntriesAtomicSync, } from "../storage/atomic-store.js";
import { resolveMemoryRoot, globalMemoryPath, userMemoryPath, dailyPath, dailyDir, projectMemoryPath, projectKeyPath, globalArchivePath, userArchivePath, projectKeyArchivePath, maestroMetaDir, } from "../storage/layout.js";
import { parseEntryBranches, parseEntrySummary, autoSummary, extractEntryDate, } from "../storage/legacy-format.js";
...
export class MaestroMemoryStore {
    ...
    replace(target, match, newContent, cwd) {
        try {
            this.assertNotBlocked();
        }
        catch (e) {
