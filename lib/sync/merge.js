...
function extractMemoryId(entry) {
 ...
 */
export function mapById(entries) {
    const m = new Map();
...
export function mergeTodoEntries(opts) {
...
export function snapshotIds(entriesByTrack) {
    const out = {};
