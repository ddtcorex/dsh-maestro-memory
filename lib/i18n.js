...
export const SNAPSHOT_DICT = {
  ...
  'ctx.keyWithBranch': ["[This project's key memories (branch {branch})]", "[This project's key memories (branch {branch})]"],
  'ctx.keyPlain': ["[This project's key memories]", "[This project's key memories]"],
}
...
export const SYNC_WORKER_DICT = {
  ...
  'syncw.fileNotWhitelisted': ["Conflict {index}'s target file is not in the sync whitelist ({file}) — write refused", "Conflict {index}'s target file is not in the sync whitelist ({file}) — write refused"],
