...
function MemoryView({ ctx }) {
    ...
    return React.createElement('div', { style: { padding: 16, fontFamily: 'system-ui, sans-serif', color: STYLE.text } }, React.createElement('div', { style: { display: 'flex', gap: 8, marginBottom: 12, flexWrap: 'wrap' } }, ['memory', 'review', 'todos', 'skills'].map((k) => React.createElement('button', {
        key: k,
        onClick: () => setTab(k),
        style: {
